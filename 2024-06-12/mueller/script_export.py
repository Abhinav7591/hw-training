    ...
    def data_document(self):
        ...
        with open(self.output_csv_path, mode='w', newline='', encoding='utf-8') as file:
            ...
            for doc in self.documents:
                ...
                if 'variants' not in doc or not doc['variants']:
                    doc['variants'] = ''

                if 'nutritional_information' not in doc or not doc['nutritional_information']:
                    doc['nutritional_information'] = ''

                promo_desc = doc.get('promotion_description', '')
...
if __name__ == "__main__":
    processor = ExportData("mueller_data.csv")
