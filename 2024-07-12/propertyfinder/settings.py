...
main_url = 'https://www.propertyfinder.ae/en/buy/properties-for-sale.html'

headers = {
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7,ml;q=0.6',
    'cache-control': 'max-age=0',
    'if-none-match': '"kxu0lf523di9vq"',
    'priority': 'u=0, i',
    'referer': 'https://www.propertyfinder.ae/en/search?c=2&fu=0&rp=y&ob=mr',
